...
class AndroidEnvironment {
  ...
  String _libGccWorkaround(String buildDir, Version ndkVersion) {
    ...
    // NDK r28+ supports 16KB by default, but we add flags for compatibility
    rustFlags = '$rustFlags\x1f-C\x1flink-arg=-Wl,-z,max-page-size=16384';

    // For NDK r22 and earlier, also add common-page-size due to linker bugs
    if (ndkVersion.major <= 22) {
